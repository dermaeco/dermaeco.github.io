...
const resources = {
  en: {
    translation: {
      ...
      'hero.features.aiPowered.description': 'Advanced artificial intelligence to precisely identify your skin needs',
      'hero.features.trusted.title': 'Trusted',
      'hero.features.trusted.description': 'Based on scientific research and dermatologist recommendations',
      'hero.features.evidenceBased.title': 'Evidence-Based Skincare',
      'hero.features.evidenceBased.description': 'All recommendations backed by clinical research and dermatological science',
      'hero.features.gdpr.title': 'GDPR Compliant',
      'hero.features.gdpr.description': 'Your data security is our top priority',
      ...
      'vision.sectionTitle': 'Core Business Assumptions',
      'vision.assumptions.accessible.title': 'Making Quality Skincare Accessible',
      'vision.assumptions.accessible.description': 'We believe everyone should have access to professional-grade skincare advice and quality product recommendations',
      'vision.assumptions.community.title': 'Data-Driven Insights',
      'vision.assumptions.community.description': 'By collecting and analyzing user skincare data, we can continuously improve our AI algorithms to provide more accurate recommendations for everyone',
      'vision.assumptions.sustainable.title': 'Sustainable Business Model',
      'vision.assumptions.sustainable.description': 'Through affiliate partnerships and value-added services, we can build sustainable revenue streams while maintaining a free user experience',
      'vision.gdpr.title': 'GDPR Compliance Commitment',
      'vision.gdpr.description': 'We are committed to protecting your privacy and ensuring compliance with the General Data Protection Regulation (GDPR).',
  ...
  de: {
    translation: {
      ...
      'hero.features.aiPowered.description': 'Fortschrittliche künstliche Intelligenz zur präzisen Identifizierung Ihrer Hautbedürfnisse',
      'hero.features.trusted.title': 'Vertrauenswürdig',
      'hero.features.trusted.description': 'Basierend auf wissenschaftlicher Forschung und Dermatologen-Empfehlungen',
      'hero.features.evidenceBased.title': 'Evidenzbasierte Hautpflege',
      'hero.features.evidenceBased.description': 'Alle Empfehlungen basieren auf klinischer Forschung und dermatologischer Wissenschaft',
      'hero.features.gdpr.title': 'DSGVO-konform',
      'hero.features.gdpr.description': 'Ihre Datensicherheit ist unsere oberste Priorität',
      ...
      'vision.sectionTitle': 'Zentrale Geschäftsannahmen',
      'vision.assumptions.accessible.title': 'Hochwertige Hautpflege zugänglich machen',
      'vision.assumptions.accessible.description': 'Wir glauben, dass jeder Zugang zu professioneller Hautpflegeberatung und hochwertigen Produktempfehlungen haben sollte',
      'vision.assumptions.community.title': 'Datengetriebene Erkenntnisse',
      'vision.assumptions.community.description': 'Durch Sammeln und Analysieren von Benutzerhautpflegedaten können wir unsere KI-Algorithmen kontinuierlich verbessern und jedem präzisere Empfehlungen geben',
      'vision.assumptions.sustainable.title': 'Nachhaltiges Geschäftsmodell',
      'vision.assumptions.sustainable.description': 'Durch Affiliate-Partnerschaften und Mehrwertdienste können wir nachhaltige Einnahmequellen aufbauen und gleichzeitig das kostenlose Benutzererlebnis beibehalten',
      'vision.gdpr.title': 'DSGVO-Konformitätsverpflichtung',
      'vision.gdpr.description': 'Wir verpflichten uns, Ihre Privatsphäre zu schützen und die Einhaltung der Datenschutz-Grundverordnung (DSGVO) sicherzustellen.',
  ...
  fr: {
    translation: {
      ...
      'hero.features.aiPowered.title': 'Analyse alimentée par IA',
      'hero.features.aiPowered.description': 'Intelligence artificielle avancée pour identifier précisément vos besoins cutanés',
      'hero.features.trusted.title': 'De confiance',
      'hero.features.trusted.description': 'Basé sur la recherche scientifique et les recommandations des dermatologues',
      'hero.features.evidenceBased.title': 'Soins basés sur les preuves',
      'hero.features.evidenceBased.description': 'Toutes les recommandations sont soutenues par la recherche clinique et la science dermatologique',
      'hero.features.gdpr.title': 'Conforme RGPD',
      'hero.features.gdpr.description': 'La sécurité de vos données est notre priorité absolue',
      ...
      'vision.sectionTitle': 'Hypothèses commerciales fondamentales',
      'vision.assumptions.accessible.title': 'Démocratiser les soins de qualité',
      'vision.assumptions.accessible.description': 'Nous croyons que chacun devrait avoir accès à des conseils de soins professionnels et à des recommandations de produits de qualité',
      'vision.assumptions.community.title': 'Insights basés sur les données',
      'vision.assumptions.community.description': 'En collectant et analysant les données de soins des utilisateurs, nous pouvons continuellement améliorer nos algorithmes IA pour fournir des recommandations plus précises à chacun',
      'vision.assumptions.sustainable.title': 'Modèle commercial durable',
      'vision.assumptions.sustainable.description': 'Grâce aux partenariats d\'affiliation et aux services à valeur ajoutée, nous pouvons construire des sources de revenus durables tout en maintenant une expérience utilisateur gratuite',
      'vision.gdpr.title': 'Engagement de conformité RGPD',
      'vision.gdpr.description': 'Nous nous engageons à protéger votre vie privée et à assurer la conformité avec le Règlement Général sur la Protection des Données (RGPD).',
  ...
  zh: {
    translation: {
      ...
      'hero.features.aiPowered.title': 'AI驱动分析',
      'hero.features.aiPowered.description': '先进的人工智能技术，精准识别您的肌肤需求',
      'hero.features.trusted.title': '值得信赖',
      'hero.features.trusted.description': '基于科学研究和皮肤专家的建议',
      'hero.features.evidenceBased.title': '循证护肤',
      'hero.features.evidenceBased.description': '所有建议均基于临床研究和皮肤科学原理',
      'hero.features.gdpr.title': 'GDPR合规',
      'hero.features.gdpr.description': '您的数据安全是我们的首要任务',
      ...
      'vision.sectionTitle': '核心业务假设',
      'vision.assumptions.accessible.title': '普及高质量护肤',
      'vision.assumptions.accessible.description': '我们相信每个人都应该获得专业级的皮肤护理建议和优质产品推荐',
      'vision.assumptions.community.title': '数据驱动的洞察',
      'vision.assumptions.community.description': '通过收集和分析用户护肤数据，我们可以不断改进我们的AI算法，为每个人提供更精准的建议',
      'vision.assumptions.sustainable.title': '可持续的商业模式',
      'vision.assumptions.sustainable.description': '通过联盟合作和增值服务，我们可以在保持用户免费体验的同时建立可持续的收入来源',
      'vision.gdpr.title': 'GDPR合规承诺',
      'vision.gdpr.description': '我们致力于保护您的隐私并确保遵守通用数据保护条例（GDPR）。',
      ...
      'vision.gdpr.userRights.description': '您有权访问、更正、删除、限制处理、数据可移植性以及反对处理您的个人数据。',
      'vision.gdpr.consent.title': '同意管理',
      'vision.gdpr.consent.description': '我们获得明确的数据处理同意，并允许您随时通过隐私设置撤回同意。',
