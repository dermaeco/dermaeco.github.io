...
const resources = {
  en: {
    translation: {
      ...
      'profile.subtitle': 'Manage your account and view your skin analysis history',
      ...
      'profile.view_analysis': 'View',
      'profile.delete_analysis': 'Delete Analysis',
      'profile.confirm_delete': 'Are you sure you want to delete this analysis?',
      'profile.delete_success': 'Analysis deleted successfully',
      'profile.delete_failed': 'Failed to delete analysis',
      'profile.load_failed': 'Failed to load analysis history',
      'profile.loading_analyses': 'Loading your analyses...',
      'profile.no_analyses': 'No analyses yet',
      'profile.start_first_analysis': 'Start Your First Analysis',
      'profile.signin_required': 'Sign In Required',
      'profile.signin_description': 'Please sign in to view your profile and analysis history',
      'profile.skin_type': 'Skin Type',
      'profile.na': 'N/A',
      'profile.no_summary': 'No summary available',
  ...
  de: {
    translation: {
      ...
      'profile.subtitle': 'Verwalten Sie Ihr Konto und sehen Sie Ihren Hautanalyseverlauf',
      ...
      'profile.view_analysis': 'Anzeigen',
      'profile.delete_analysis': 'Analyse löschen',
      'profile.confirm_delete': 'Möchten Sie diese Analyse wirklich löschen?',
      'profile.delete_success': 'Analyse erfolgreich gelöscht',
      'profile.delete_failed': 'Fehler beim Löschen der Analyse',
      'profile.load_failed': 'Fehler beim Laden des Analyseverlaufs',
      'profile.loading_analyses': 'Ihre Analysen werden geladen...',
      'profile.no_analyses': 'Noch keine Analysen',
      'profile.start_first_analysis': 'Starten Sie Ihre erste Analyse',
      'profile.signin_required': 'Anmeldung erforderlich',
      'profile.signin_description': 'Bitte melden Sie sich an, um Ihr Profil und Ihren Analyseverlauf anzuzeigen',
      'profile.skin_type': 'Hauttyp',
      'profile.na': 'N/A',
      'profile.no_summary': 'Keine Zusammenfassung verfügbar',
  ...
  fr: {
    translation: {
      ...
      'profile.subtitle': 'Gérez votre compte et consultez votre historique d\'analyses cutanées',
      ...
      'profile.view_analysis': 'Voir',
      'profile.delete_analysis': 'Supprimer l\'analyse',
      'profile.confirm_delete': 'Êtes-vous sûr de vouloir supprimer cette analyse?',
      'profile.delete_success': 'Analyse supprimée avec succès',
      'profile.delete_failed': 'Échec de la suppression de l\'analyse',
      'profile.load_failed': 'Échec du chargement de l\'historique des analyses',
      'profile.loading_analyses': 'Chargement de vos analyses...',
      'profile.no_analyses': 'Aucune analyse pour le moment',
      'profile.start_first_analysis': 'Commencez votre première analyse',
      'profile.signin_required': 'Connexion requise',
      'profile.signin_description': 'Veuillez vous connecter pour voir votre profil et votre historique d\'analyses',
      'profile.skin_type': 'Type de peau',
      'profile.na': 'N/A',
      'profile.no_summary': 'Aucun résumé disponible',
  ...
  zh: {
    translation: {
      ...
      'journey.track_products': '追踪您的产品和护肤进展',
      'journey.never_miss': '不再错过您的护肤流程',
      ...
      // Profile & Comparison
      'profile.title': '我的资料',
      'profile.subtitle': '管理您的账户并查看皮肤分析历史',
      ...
      'profile.view_analysis': '查看',
      'profile.delete_analysis': '删除分析',
      'profile.confirm_delete': '确定要删除此分析吗？',
      'profile.delete_success': '分析已成功删除',
      'profile.delete_failed': '删除分析失败',
      'profile.load_failed': '加载分析历史失败',
      'profile.loading_analyses': '正在加载您的分析...',
      'profile.no_analyses': '暂无分析',
      'profile.start_first_analysis': '开始您的第一次分析',
      'profile.signin_required': '需要登录',
      'profile.signin_description': '请登录以查看您的资料和分析历史',
      'profile.skin_type': '肤质类型',
      'profile.na': '无',
      'profile.no_summary': '无摘要',
      'compare.title': '比较分析',
