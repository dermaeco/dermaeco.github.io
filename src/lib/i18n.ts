...
const resources = {
  ...
  zh: {
    translation: {
      ...
      'vision.assumption2_title': '商业化',
      'vision.assumption2_desc': '',
      'vision.assumption3_title': 'AI美容科技市场时机',
      'vision.assumption3_desc': '',
      ...
      'vision.user_rights_desc': '您有权访问、更正、删除、限制、迁移以及反对处理您的个人数据。',
      'vision.consent': '授权管理',
      'vision.consent_desc': '我们会明确申请数据处理授权，并允许您随时通过隐私设置撤回授权。',
